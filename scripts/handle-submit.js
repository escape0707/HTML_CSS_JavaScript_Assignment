...
outputDocument.writeln(cvData.get('cv_birthday' id='birthday' required>");
outputDocument.writeln("    </div>");
outputDocument.writeln("outputDocument.writeln("  </section>");");
outputDocument.writeln("");
outputDocument.writeln("  <section>");
...
outputDocument.writeln(cvData.get('cv_degree' id='degree'>");
outputDocument.writeln("    </div>");
outputDocument.writeln("");
...
outputDocument.writeln("");
outputDocument.writeln("    <div>");
outputDocument.writeln("      自我陈述：（不少于20字）");
outputDocument.writeln("      <br>");
outputDocument.writeln(cvData.get('cv_expectation' id='expectation' placeholder='请填写对于所申请岗位的理解，以及对未来的展望。' minlength='20' required></textarea>");
outputDocument.writeln("    </div>");
outputDocument.writeln("");
outputDocument.writeln("    <div>");
outputDocument.writeln("      兴趣特长：");
outputDocument.writeln("      <br>");
outputDocument.writeln(cvData.get('cv_hobby' id='hobby' placeholder='请填写您的特长，以及获奖项目等。'></textarea>");
outputDocument.writeln("    </div>");
outputDocument.writeln("  </section>");
outputDocument.writeln("</body>");
outputDocument.writeln("");
